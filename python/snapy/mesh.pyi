...
class ScalarOptions:
    ...
    @overload
    def upper_bound(self, value: float) -> "ScalarOptions": ...
...
class MeshBlock:
    ...
    def apply_boundaries(self, vars: Variables, hydro: torch.Tensor, tracers: Optional[torch.Tensor] = None, primitive: bool = False) -> None: ...
