...
//!
//! And one consequence rather than an obligation: the fixed point is p' == C for
//! a FREE constant C, so nothing ties the result to the input. The column moves
//! -- 2.5e-4 of p on the Neptune geEx column, 1.2e-2 on a 300 km Jupiter-like
